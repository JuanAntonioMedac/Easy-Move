...
@section('title', 'Nueva ubicación · Admin EasyMove')
...
<div class="mb-8">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white">Nuevo código postal</h1>
            <p class="text-sm text-slate-500 dark:text-slate-400">Añade una nueva ubicación al sistema</p>
        </div>
    </div>
</div>
...
<div class="max-w-2xl rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-8">
    <form method="POST" action="{{ route('admin.locations.store') }}" class="space-y-5">
        ...
        <div>
            ...
            <input type="text" id="codigo_postal" name="codigo_postal" placeholder="Ej: 28001" value="{{ old('codigo_postal') }}"
        ...
        <div>
            ...
            <input type="text" id="ciudad" name="ciudad" placeholder="Ej: Madrid" value="{{ old('ciudad') }}"
