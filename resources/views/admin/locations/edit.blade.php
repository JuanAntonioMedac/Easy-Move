...
<div class="mb-8">
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">Editar Código Postal</h1>
            <p class="text-gray-600 dark:text-gray-400">Modifica los datos de la ubicación {{ $ubicacion->codigo_postal }}</p>
        </div>
    </div>
</div>
...
<div class="bg-white dark:bg-slate-900 rounded-lg shadow-md p-8 border border-gray-200 dark:border-slate-800 max-w-2xl">
    <form method="POST" action="{{ route('admin.locations.update', $ubicacion) }}" class="space-y-6">
        @csrf
        @method('PUT')
