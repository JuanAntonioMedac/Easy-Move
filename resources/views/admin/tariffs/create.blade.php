...
@section('title', 'Crear Tarifa - Admin EasyMove')
...
<div class="mb-8">
    ...
    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Crear Nueva Tarifa</h1>
</div>

@include('shared.alerts')

<div class="bg-white dark:bg-slate-900 rounded-lg shadow-md p-8 border border-gray-200 dark:border-slate-800 max-w-2xl">
    <form method="POST" action="{{ route('admin.tariffs.store') }}" class="space-y-6">
        @csrf
        ...
        <div>
            ...
            <select id="id_servicio" name="id_servicio" required
                ...
                @foreach ($servicios as $servicio)
                    <option value="{{ $servicio->id_servicio }}" @selected(old('id_servicio') == $servicio->id_servicio)>
        ...
        <div>
            ...
            <input type="text" id="nombre_tarifa" name="nombre_tarifa" value="{{ old('nombre_tarifa') }}" required
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" id="unidad_precio" name="unidad_precio" value="{{ old('unidad_precio') }}" required
        ...
        <div>
            ...
            <textarea id="condiciones" name="condiciones" rows="4"
                      ...
                      placeholder="Descripción detallada de la tarifa, incluidas condiciones especiales">{{ old('condiciones') }}</textarea>
        ...
        <div>
            ...
            <input type="url" id="url_oferta_externa" name="url_oferta_externa" value="{{ old('url_oferta_externa') }}"
