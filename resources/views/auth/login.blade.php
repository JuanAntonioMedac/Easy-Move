    ...
    <div class="relative w-full max-w-md">
        <div class="rounded-3xl border border-slate-200 dark:border-slate-700 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl shadow-2xl shadow-indigo-500/10 p-8 sm:p-10 animate-fade-in-up">
            <div class="flex flex-col items-center text-center mb-8">
                <div class="w-16 h-16 rounded-2xl grid place-items-center bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-white shadow-lg shadow-indigo-500/30 mb-4 overflow-hidden p-0.5">
